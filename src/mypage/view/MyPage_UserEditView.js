...
class MypageUserEditView extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
   ...
   // console.log("mypageUSer Edit View : "+ {this.props.user.email})
    return <div className="signup_wrap">
      <div className ="signUp_container">

    <h1 className="signup_title">정보 수정</h1>
    <form className="signup_form" onSubmit={this.handleSubmit}>
      ...
      <input id="signup_btn" type="submit" value="정보 수정!" class="btn btn-success" />
    </form>
  </div>
...
export default MypageUserEditView;
